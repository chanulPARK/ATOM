...
/**
 * Servlet implementation class SearchEmpMonthServlet
 */
@WebServlet("/attendance/searchEmpMonth")
public class SearchEmpMonthServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchEmpMonthServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Employee> empList = new EmployeeService().searchEmpList(searchEmp);
		...
		if(!searchEmp.trim().equals("")) {
			if(empList.isEmpty()) {
				msg= searchEmp + "님의 출근 기록이 존재하지 않습니다.";

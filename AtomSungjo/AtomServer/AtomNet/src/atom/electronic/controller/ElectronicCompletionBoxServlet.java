...
/**
 * Servlet implementation class ElectronicCompletionBoxServlet
 */
@WebServlet("/electronic/electronicCompletionBox")
public class ElectronicCompletionBoxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ElectronicCompletionBoxServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ElectronicApproval> list = new ElectronicService().selectCompletionApproval(e.getEmpId(), cPage, numPerPage);

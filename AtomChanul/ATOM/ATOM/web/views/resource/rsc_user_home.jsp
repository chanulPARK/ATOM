                        ...
                        <tr>
                           ...
                           <%=rl.getRscCatename() %>
                            ...
                            <% if(rl.getRscCondition().equals("Y")) //예약 가능 상태가 Y이면
                           	{%>
                           	 <button type="button" class="btn btn-success btn-sm checkbtn" onclick="location.href='<%=request.getContextPath()%>/user/reservationView?rscCode=<%=rl.getRscCode()%>'">예약 가능</button>
                          <%} 
                          	else //예약 가능 상태가 N이면
                          	{%>

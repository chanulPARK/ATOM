...
/**
 * Servlet implementation class AdminResourceAcceptListServlet
 */
@WebServlet("/admin/resourceAcceptList")
public class AdminResourceAcceptListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminResourceAcceptListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//페이징 처리 로직
				...
				{
					pageBar += "<li><a href='"+request.getContextPath()+"/admin/resourceAcceptList?cPage="+(pageNo-1)+"'aria-label='Previous'><span aria-hidden='true'>&laquo;</span></a></li>";
				}	
				...
				while(!(pageNo>pageEnd||pageNo>totalPage))
				{
					...
					{
						pageBar += "<li><a href='"+request.getContextPath()+"/admin/resourceAcceptList?cPage="+pageNo+"'aria-label='Previous'><span aria-hidden='true'>"+pageNo+"</span></a></li>";
					}
					pageNo++;
				}
				...
				{
					pageBar += "<li><a href='"+request.getContextPath()+"/admin/resourceAcceptList?cPage="+(pageNo-1)+"'aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>";
				}	

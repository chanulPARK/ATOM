                ...
                <div class="table-header">
                    <div class="row">
						...
						<div class="col-md-10 pull-right">
	                        <form class="form-inline pull-right" style="margin-right:15px" action="<%=request.getContextPath()%>/electronic/electonicReturnFinder">
...
for (i = 0; i < dropdown.length; i++) {
  ...
  $('#numperPage').change(function(){
	  location.href='<%=request.getContextPath()%>/electronic/electronicReturnBox?cPage=1&numPerPage='+$('#numperPage').val();

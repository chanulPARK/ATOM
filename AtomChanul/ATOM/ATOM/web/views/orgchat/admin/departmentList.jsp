  ...
  <div class="col-sm-8 text-left"> <!-- container 영역  --> 
   ...
   <div>
	...
	<%-- "<%=request.getContextPath() %>/deptInsert" --%>
     ...
     <li><a href="<%=request.getContextPath() %>/deptInsertEnd">부서추가</a></li>
     <li><a href="#">부서수정</a></li>
     <li><a href="#">부서삭제</a></li>
     ...
     <%for(Dept d: dept) {%>
      ...
      <tr>
       ...
       <td><%=d.getDeptName() %></td>
		  ...
		  <td><button id="btnDelete" type="button" class="btn btn-default btn-sm">수정</button></td>
       <td><button id="btnDelete" type="button" class="btn btn-default btn-sm">삭제</button></td>

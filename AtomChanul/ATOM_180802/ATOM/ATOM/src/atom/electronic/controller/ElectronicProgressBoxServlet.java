...
/**
 * Servlet implementation class ElectronicProgressBoxServlet
 */
@WebServlet("/electronic/electronicProgressBox")
public class ElectronicProgressBoxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ElectronicProgressBoxServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ElectronicApproval> list = new ElectronicService().selectProgressApproval(e.getEmpId(), cPage, numPerPage);
		
		
		//pageBar만들기!! 만들어 볼까요?!
				//전체 자료수
				int totalContent=new ElectronicService().selectProgressApprovalCount(e.getEmpId());
				String pageBar="";

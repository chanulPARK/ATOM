...
/**
 * Servlet implementation class MainEndBtnServlet
 */
@WebServlet("/attendance/mainEndBtn")
public class MainEndBtnServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MainEndBtnServlet() {
        super();
